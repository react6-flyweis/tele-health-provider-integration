...
const INITIAL_SESSION_TYPES: SessionType[] = [
  { name: "Initial Consultation", type: "Video Session", duration: 60, price: "$200" },
  { name: "Follow-up Session", type: "Video Session", duration: 50, price: "$150" },
  { name: "Therapy Session", type: "Video Session", duration: 50, price: "$150" },
  { name: "Medication Review", type: "Video Session", duration: 30, price: "$100" },
];
...
export default function AvailabilityPage() {
  ...
  function parseFeeToNumber(price: string) {
    const numericValue = Number(price.replace(/[^\d.]/g, "").trim());
  ...
  function handleSaveSessionTypes() {
    const payloadSessionTypes = sessionTypes
      .map((item) => ({
        ...
        type: item.type.trim(),
        duration: item.duration,
        price: parseFeeToNumber(item.price),
      }))
